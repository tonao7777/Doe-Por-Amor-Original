...
window.smoothScroll = (function (window, document, undefined) {
  ...
  // Private method
  // Returns an {object}
  var _mergeObjects = function ( original, atualizar ) {
    for (var key in atualizar) {
      original[key] = atualizar[key];
    }
    return original;
  };
  ...
  var animateScroll = function ( toggle, anchor, options, event ) {
    ...
    options = _mergeObjects( predefinir, options || {} ); // Merge user options with defaults
